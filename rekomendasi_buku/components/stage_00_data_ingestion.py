import os
import sys
import urllib.request   # langsung pakai urllib bawaan Python
import zipfile

from rekomendasi_buku.logger.log import logging
from rekomendasi_buku.exception.exception_handler import AppException
from rekomendasi_buku.config.configuration import AppConfiguration
...
class DataIngestion:
    ...
    def download_data(self):
        """
        Fetch the data from the url and save as zip
        """
        try:
    ...
    def extract_zip_file(self, zip_file_path: str):
        ...
        try:
            ...
            logging.info(f"Extracted {zip_file_path} into dir: {ingested_dir}")
        except Exception as e:
            raise AppException(e, sys) from e
